...
long __attribute__((__always_inline__)) cdda_read(cdrom_drive *disc, void *buffer, long beginLSN, long nSectors){
	return xld_cdda_read(disc, buffer, beginLSN, nSectors);
}
long __attribute__((__always_inline__)) cdda_read_timed(cdrom_drive *disc, void *buffer, long beginLSN, long nSectors, int *ms){
	return xld_cdda_read_timed(disc, buffer, beginLSN, nSectors, ms);
}
long __attribute__((__always_inline__)) cdda_disc_firstsector(cdrom_drive_t *disc) {
	return xld_cdda_disc_firstsector(disc);
}
long __attribute__((__always_inline__)) cdda_disc_lastsector(cdrom_drive_t *disc) {
	return xld_cdda_disc_lastsector(disc);
}
int __attribute__((__always_inline__)) cdda_disc_lastsector_currentsession(cdrom_drive_t *disc, int session) {
	return xld_cdda_disc_lastsector_currentsession(disc, session);
}
int __attribute__((__always_inline__)) cdda_sector_gettrack(cdrom_drive_t *disc, long sector) {
	return xld_cdda_sector_gettrack(disc, sector);
}
long __attribute__((__always_inline__)) cdda_tracks(cdrom_drive_t *disc) {
	return xld_cdda_tracks(disc);
}
long __attribute__((__always_inline__)) cdda_track_firstsector(cdrom_drive_t *disc, int track) {
	return xld_cdda_track_firstsector(disc, track);
}
long __attribute__((__always_inline__)) cdda_track_lastsector(cdrom_drive_t *disc, int track) {
	return xld_cdda_track_lastsector(disc, track);
}
int __attribute__((__always_inline__)) cdda_track_audiop(cdrom_drive_t *disc, int track) {
	return xld_cdda_track_audiop(disc, track);
}
int __attribute__((__always_inline__)) cdda_speed_set(cdrom_drive_t *disc, int speed) {
	return xld_cdda_speed_set(disc, speed);
}
