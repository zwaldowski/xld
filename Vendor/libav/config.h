...
#define LIBAV_CONFIGURATION "--disable-doc --disable-debug --enable-shared --disable-everything --enable-decoder=tak --enable-parser=tak --enable-demuxer=tak --enable-decoder=tta --enable-demuxer=tta --disable-swscale --disable-avfilter --disable-avresample --disable-avdevice --enable-avcodec"
